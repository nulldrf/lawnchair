...
object ColorTokens {
    ...
    @JvmField val AllAppsHeaderProtectionColor = StaticColorToken(0x00000000)
    ...
    @JvmField val BottomSheetBackgroundColorBlurFallback = DayNightColorToken(Neutral1_50, Neutral1_900)
